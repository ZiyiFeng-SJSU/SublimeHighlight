...
class SublimeHighlightCommand(sublime_plugin.TextCommand):
    ...
    def get_lexer(self, code=None):
        ...
        # lexer = pygments.lexers.get_lexer_by_name("MIPS", stripall=True);
        # lexer = pygments.lexers.get_lexer_by_name("GAS", stripall=True);
